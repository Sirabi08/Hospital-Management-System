...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2024 at 06:42 PM
...
INSERT INTO `appointments` (`id`, `doctor_id`, `patient_id`, `appointment_date`, `appointment_time`) VALUES
(1, 1, 1, '2024-10-05', '23:10:00');
...
INSERT INTO `doctors` (`id`, `name`, `specialty`, `specialization`, `phone`, `email`) VALUES
(1, 'kathija siraj', '', 'phycologist', '06382715611', 'sirabi08@gmail.com');
...
INSERT INTO `patients` (`id`, `name`, `contact`, `phone`, `email`) VALUES
(1, 'siraj', '', '06379203911', 'sirabi08@gmail.com');
...
(0, '[value-2]', '[value-3]', ''),
(5, 'admin', '$2y$10$JlNVlyFHrTmgyY6vyh4xd.kcBTFInv2RfonB49cRzXqB0QN2/nakW', 'admin');
